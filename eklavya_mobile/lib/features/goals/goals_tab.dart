...
class _GoalsTabState extends State<GoalsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayedGoals = selectedDomain == 'All' 
        ? goals 
        : goals.where((g) => g.domain.toLowerCase() == selectedDomain.toLowerCase()).toList();
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.all(Radius.circular(8)), // Using explicit Radius to avoid conflicts
              ),
            ),
          );
        },
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text('${goals.where((g) => g.status == 'active').length} active goals', 
